    ...
    <footer className="relative h-48 w-full mt-20 ">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full gap-4">
        ...
        <div className="flex gap-6 mb-5">
          ...
          <a href="https://www.instagram.com/jambakescakes/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-600">
        ...
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm mb-5">
          ...
          <a href="/payment-terms" className="hover:text-gray-600">COLLECTIONS</a>
