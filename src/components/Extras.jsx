...
export default function Extras() {
    return(
<div className='container relative mx-auto max-w-screen-md  p-10 
            ...
            <div id="about" className="relative z-10 font-main-font">
                ...
                <p className='body-text bg-white/30 rounded-lg p-4'>
                    ...
                    <i>(recommended for tiered displayed cakes, i.e. weddings)</i> <br/><br/>

                    Strawberries, Raspberries, Blueberries, Choc Chips, Sprinkles<br/><br/>

                    Alcohol: Brandy, Rum, Limoncello <br/><br/>

                    Coloured sponge available in standard flavours only<br/>
